...
SECRET_KEY = 'django-insecure-ud)hu5t117j0(zydy9#+wc)$-+fyj8a-awmh#q=f*rca4(3&og'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['54.144.238.122', 'localhost', 'fixedgearsolace.com']
...
ROOT_URLCONF = 'fixedgearblog.urls'
...
WSGI_APPLICATION = 'fixedgearblog.wsgi.application'
